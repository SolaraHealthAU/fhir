...
import { createValueSetSubPropertySchema } from "../valuesetsubproperty/schema";

/* Generated from FHIR JSON Schema */

export function createValueSetProperty1Schema() {
  const baseSchema: z.ZodType<types.ValueSetProperty1> = z.object({
    ...
    subProperty: z
      .array(z.lazy(() => createValueSetSubPropertySchema()))
      .optional(),
  });
