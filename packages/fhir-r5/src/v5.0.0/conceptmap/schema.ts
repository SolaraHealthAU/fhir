...
import { createConceptMapPropertySchema } from "../conceptmapproperty/schema";
import { createConceptMapAdditionalAttributeSchema } from "../conceptmapadditionalattribute/schema";
...
export function createConceptMapSchema() {
  const baseSchema: z.ZodType<types.ConceptMap> = z.object({
    ...
    relatedArtifact: z
      ...
      .optional(),
    property: z
      .array(z.lazy(() => createConceptMapPropertySchema()))
      .optional(),
    additionalAttribute: z
      .array(z.lazy(() => createConceptMapAdditionalAttributeSchema()))
      .optional(),
    sourceScopeUri: z.string().optional(),
    _sourceScopeUri: z.lazy(() => createElementSchema()).optional(),
    sourceScopeCanonical: z.string().optional(),
    _sourceScopeCanonical: z.lazy(() => createElementSchema()).optional(),
    targetScopeUri: z.string().optional(),
    _targetScopeUri: z.lazy(() => createElementSchema()).optional(),
    targetScopeCanonical: z.string().optional(),
    _targetScopeCanonical: z.lazy(() => createElementSchema()).optional(),
