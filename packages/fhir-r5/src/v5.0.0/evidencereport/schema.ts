...
import { createEvidenceReportSubjectSchema } from "../evidencereportsubject/schema";
import { createEvidenceReportRelatesToSchema } from "../evidencereportrelatesto/schema";
import { createEvidenceReportSectionSchema } from "../evidencereportsection/schema";

/* Generated from FHIR JSON Schema */

export function createEvidenceReportSchema() {
  const baseSchema: z.ZodType<types.EvidenceReport> = z.object({
    ...
    subject: z.lazy(() => createEvidenceReportSubjectSchema()),
    relatesTo: z
      .array(z.lazy(() => createEvidenceReportRelatesToSchema()))
      .optional(),
    section: z
