...
import { createGraphDefinitionNodeSchema } from "../graphdefinitionnode/schema";
...
export function createGraphDefinitionSchema() {
  const baseSchema: z.ZodType<types.GraphDefinition> = z.object({
    ...
    start: primitives.createIdSchema().optional(),
    _start: z.lazy(() => createElementSchema()).optional(),
    node: z.array(z.lazy(() => createGraphDefinitionNodeSchema())).optional(),
