...
import { createBodyStructureIncludedStructureSchema } from "../bodystructureincludedstructure/schema";
...
export function createBodyStructureSchema() {
  const baseSchema: z.ZodType<types.BodyStructure> = z.object({
    ...
    includedStructure: z.array(
      z.lazy(() => createBodyStructureIncludedStructureSchema()),
    ),
    excludedStructure: z
      .array(z.lazy(() => createBodyStructureIncludedStructureSchema()))
      .optional(),
