...
import { createCoverageEligibilityRequestEventSchema } from "../coverageeligibilityrequestevent/schema";
...
export function createCoverageEligibilityRequestSchema() {
  const baseSchema: z.ZodType<types.CoverageEligibilityRequest> = z.object({
    ...
    event: z
      .array(z.lazy(() => createCoverageEligibilityRequestEventSchema()))
      .optional(),
