...
export function createAppointmentResponseSchema() {
  const baseSchema: z.ZodType<types.AppointmentResponse> = z.object({
    ...
    proposedNewTime: primitives.createBooleanSchema().optional(),
    _proposedNewTime: z.lazy(() => createElementSchema()).optional(),
    ...
    participantStatus: primitives.createCodeSchema().optional(),
    ...
    recurring: primitives.createBooleanSchema().optional(),
    _recurring: z.lazy(() => createElementSchema()).optional(),
    occurrenceDate: primitives.createDateSchema().optional(),
    _occurrenceDate: z.lazy(() => createElementSchema()).optional(),
