...
import { createObservationDefinitionComponentSchema } from "../observationdefinitioncomponent/schema";
...
export function createObservationDefinitionSchema() {
  const baseSchema: z.ZodType<types.ObservationDefinition> = z.object({
    ...
    subject: z.array(z.lazy(() => createCodeableConceptSchema())).optional(),
    ...
    component: z
      .array(z.lazy(() => createObservationDefinitionComponentSchema()))
      .optional(),
  });
