...
import { createRequirementsStatementSchema } from "../requirementsstatement/schema";

/* Generated from FHIR JSON Schema */

export function createRequirementsSchema() {
  const baseSchema: z.ZodType<types.Requirements> = z.object({
    ...
    actor: z.array(primitives.createCanonicalSchema()).optional(),
    statement: z
      .array(z.lazy(() => createRequirementsStatementSchema()))
      .optional(),
  });
