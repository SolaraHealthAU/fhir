...
import { createSpecimenFeatureSchema } from "../specimenfeature/schema";
...
export function createSpecimenSchema() {
  const baseSchema: z.ZodType<types.Specimen> = z.object({
    ...
    combined: primitives.createCodeSchema().optional(),
    _combined: z.lazy(() => createElementSchema()).optional(),
    role: z.array(z.lazy(() => createCodeableConceptSchema())).optional(),
    feature: z.array(z.lazy(() => createSpecimenFeatureSchema())).optional(),
