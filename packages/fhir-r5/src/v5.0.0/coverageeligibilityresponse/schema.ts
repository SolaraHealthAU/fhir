...
import { createCoverageEligibilityResponseEventSchema } from "../coverageeligibilityresponseevent/schema";
...
export function createCoverageEligibilityResponseSchema() {
  const baseSchema: z.ZodType<types.CoverageEligibilityResponse> = z.object({
    ...
    purpose: z.array(primitives.createCodeSchema()).optional(),
    _purpose: z.array(z.lazy(() => createElementSchema())).optional(),
    patient: z.lazy(() => createReferenceSchema()),
    event: z
      .array(z.lazy(() => createCoverageEligibilityResponseEventSchema()))
      .optional(),
