...
export function createCompartmentDefinitionResourceSchema() {
  const baseSchema: z.ZodType<types.CompartmentDefinitionResource> = z.object({
    ...
    startParam: primitives.createUriSchema().optional(),
    _startParam: z.lazy(() => createElementSchema()).optional(),
    endParam: primitives.createUriSchema().optional(),
    _endParam: z.lazy(() => createElementSchema()).optional(),
  });
