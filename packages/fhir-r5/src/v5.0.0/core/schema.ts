...
import { createAvailabilityAvailableTimeSchema } from "../availabilityavailabletime/schema";
import { createAvailabilityNotAvailableTimeSchema } from "../availabilitynotavailabletime/schema";
...
import { createDataRequirementValueFilterSchema } from "../datarequirementvaluefilter/schema";
...
export function createExtensionSchema() {
  const baseSchema: z.ZodType<types.Extension> = z.object({
    ...
    _valueInteger64: z.lazy(() => createElementSchema()).optional(),
    ...
    valueRatioRange: z.lazy(() => createRatioRangeSchema()).optional(),
    ...
    valueAvailability: z.lazy(() => createAvailabilitySchema()).optional(),
...
export function createAttachmentSchema() {
  const baseSchema: z.ZodType<types.Attachment> = z.object({
    ...
    _url: z.lazy(() => createElementSchema()).optional(),
    size: primitives.createInteger64Schema().optional(),
    ...
    pages: primitives.createPositiveIntSchema().optional(),
    _pages: z.lazy(() => createElementSchema()).optional(),
  });
...
export function createCodeableReferenceSchema() {
  const baseSchema: z.ZodType<types.CodeableReference> = z.object({
    id: primitives.createStringSchema().optional(),
    extension: z.array(z.lazy(() => createExtensionSchema())).optional(),
    concept: z.lazy(() => createCodeableConceptSchema()).optional(),
...
export function createRatioRangeSchema() {
  const baseSchema: z.ZodType<types.RatioRange> = z.object({
    id: primitives.createStringSchema().optional(),
    extension: z.array(z.lazy(() => createExtensionSchema())).optional(),
    lowNumerator: z.lazy(() => createQuantitySchema()).optional(),
    highNumerator: z.lazy(() => createQuantitySchema()).optional(),
    denominator: z.lazy(() => createQuantitySchema()).optional(),
  });
...
export function createSampledDataSchema() {
  const baseSchema: z.ZodType<types.SampledData> = z.object({
    ...
    interval: primitives.createDecimalSchema().optional(),
    _interval: z.lazy(() => createElementSchema()).optional(),
    intervalUnit: primitives.createCodeSchema(),
    _intervalUnit: z.lazy(() => createElementSchema()).optional(),
    ...
    codeMap: primitives.createCanonicalSchema().optional(),
    offsets: primitives.createStringSchema().optional(),
    _offsets: z.lazy(() => createElementSchema()).optional(),
...
export function createSignatureSchema() {
  const baseSchema: z.ZodType<types.Signature> = z.object({
    ...
    when: primitives.createInstantSchema().optional(),
...
export function createExtendedContactDetailSchema() {
  const baseSchema: z.ZodType<types.ExtendedContactDetail> = z.object({
    id: primitives.createStringSchema().optional(),
    extension: z.array(z.lazy(() => createExtensionSchema())).optional(),
...
export function createAvailabilitySchema() {
  const baseSchema: z.ZodType<types.Availability> = z.object({
    id: primitives.createStringSchema().optional(),
    extension: z.array(z.lazy(() => createExtensionSchema())).optional(),
    availableTime: z
      .array(z.lazy(() => createAvailabilityAvailableTimeSchema()))
      .optional(),
    notAvailableTime: z
      .array(z.lazy(() => createAvailabilityNotAvailableTimeSchema()))
      .optional(),
  });
...
export function createDataRequirementSchema() {
  const baseSchema: z.ZodType<types.DataRequirement> = z.object({
    ...
    dateFilter: z
      ...
      .optional(),
    valueFilter: z
      .array(z.lazy(() => createDataRequirementValueFilterSchema()))
      .optional(),
...
export function createRelatedArtifactSchema() {
  const baseSchema: z.ZodType<types.RelatedArtifact> = z.object({
    ...
    publicationDate: primitives.createDateSchema().optional(),
...
export function createTriggerDefinitionSchema() {
  const baseSchema: z.ZodType<types.TriggerDefinition> = z.object({
    ...
    _name: z.lazy(() => createElementSchema()).optional(),
    code: z.lazy(() => createCodeableConceptSchema()).optional(),
    subscriptionTopic: primitives.createCanonicalSchema().optional(),
...
export function createDosageSchema() {
  const baseSchema: z.ZodType<types.Dosage> = z.object({
    ...
    doseAndRate: z
      ...
      .optional(),
    maxDosePerPeriod: z.array(z.lazy(() => createRatioSchema())).optional(),
