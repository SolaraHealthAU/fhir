...
import { createTestPlanDependencySchema } from "../testplandependency/schema";
import { createTestPlanTestCaseSchema } from "../testplantestcase/schema";

/* Generated from FHIR JSON Schema */

export function createTestPlanSchema() {
  const baseSchema: z.ZodType<types.TestPlan> = z.object({
    ...
    testTools: primitives.createMarkdownSchema().optional(),
    _testTools: z.lazy(() => createElementSchema()).optional(),
    dependency: z
      .array(z.lazy(() => createTestPlanDependencySchema()))
      .optional(),
    exitCriteria: primitives.createMarkdownSchema().optional(),
    _exitCriteria: z.lazy(() => createElementSchema()).optional(),
    testCase: z.array(z.lazy(() => createTestPlanTestCaseSchema())).optional(),
  });
