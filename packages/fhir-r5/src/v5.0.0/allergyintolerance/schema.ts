...
import { createAllergyIntoleranceParticipantSchema } from "../allergyintoleranceparticipant/schema";
...
export function createAllergyIntoleranceSchema() {
  const baseSchema: z.ZodType<types.AllergyIntolerance> = z.object({
    ...
    category: z.array(primitives.createCodeSchema()).optional(),
    _category: z.array(z.lazy(() => createElementSchema())).optional(),
    criticality: primitives.createCodeSchema().optional(),
    ...
    participant: z
      .array(z.lazy(() => createAllergyIntoleranceParticipantSchema()))
      .optional(),
