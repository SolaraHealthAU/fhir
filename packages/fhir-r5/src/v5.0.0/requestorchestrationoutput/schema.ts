...
export function createRequestOrchestrationOutputSchema() {
  const baseSchema: z.ZodType<types.RequestOrchestrationOutput> = z.object({
    ...
    relatedData: primitives.createStringSchema().optional(),
