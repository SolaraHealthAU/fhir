...
import { createCitationSummarySchema } from "../citationsummary/schema";
import { createCitationClassificationSchema } from "../citationclassification/schema";
import { createCitationStatusDateSchema } from "../citationstatusdate/schema";
import { createCitationCitedArtifactSchema } from "../citationcitedartifact/schema";

/* Generated from FHIR JSON Schema */

export function createCitationSchema() {
  const baseSchema: z.ZodType<types.Citation> = z.object({
    ...
    relatedArtifact: z
      ...
      .optional(),
    summary: z.array(z.lazy(() => createCitationSummarySchema())).optional(),
    classification: z
      .array(z.lazy(() => createCitationClassificationSchema()))
      .optional(),
    ...
    currentState: z
      ...
      .optional(),
    statusDate: z
      .array(z.lazy(() => createCitationStatusDateSchema()))
      .optional(),
    citedArtifact: z.lazy(() => createCitationCitedArtifactSchema()).optional(),
  });
