...
export function createMeasureSchema() {
  const baseSchema: z.ZodType<types.Measure> = z.object({
    ...
    riskAdjustment: primitives.createStringSchema().optional(),
    _riskAdjustment: z.lazy(() => createElementSchema()).optional(),
    rateAggregation: primitives.createStringSchema().optional(),
    ...
    definition: z.array(primitives.createMarkdownSchema()).optional(),
