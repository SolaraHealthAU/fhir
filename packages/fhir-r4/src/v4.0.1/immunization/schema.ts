...
>(options?: { contained?: C; allowNested?: boolean }) {
  ...
  return getCachedSchema("Immunization", [contained], () => {
    const baseSchema: z.ZodType<types.Immunization<z.infer<C>>> =
      z.strictObject({
...
>(options?: { contained?: C; allowNested?: boolean }) {
  ...
  return getCachedSchema("ImmunizationEvaluation", [contained], () => {
    const baseSchema: z.ZodType<types.ImmunizationEvaluation<z.infer<C>>> =
      z.strictObject({
...
>(options?: { contained?: C; allowNested?: boolean }) {
  ...
  return getCachedSchema("ImmunizationRecommendation", [contained], () => {
    const baseSchema: z.ZodType<types.ImmunizationRecommendation<z.infer<C>>> =
      z.strictObject({
