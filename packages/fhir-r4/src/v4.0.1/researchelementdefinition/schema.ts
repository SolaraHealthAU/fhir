...
export function createResearchElementDefinitionSchema() {
  const baseSchema: z.ZodType<types.ResearchElementDefinition> = z.object({
    ...
    variableType: z
      ...
      .optional(),
    _variableType: z.lazy(() => createElementSchema()).optional(),
    characteristic: z.array(
      z.lazy(() => createResearchElementDefinitionCharacteristicSchema()),
    ),
  });
