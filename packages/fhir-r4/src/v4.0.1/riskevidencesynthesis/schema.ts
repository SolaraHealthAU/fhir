...
export function createRiskEvidenceSynthesisSchema() {
  const baseSchema: z.ZodType<types.RiskEvidenceSynthesis> = z.object({
    ...
    exposure: z.lazy(() => createReferenceSchema()).optional(),
    outcome: z.lazy(() => createReferenceSchema()),
    sampleSize: z
      .lazy(() => createRiskEvidenceSynthesisSampleSizeSchema())
      .optional(),
    riskEstimate: z
      .lazy(() => createRiskEvidenceSynthesisRiskEstimateSchema())
      .optional(),
    certainty: z
      .array(z.lazy(() => createRiskEvidenceSynthesisCertaintySchema()))
      .optional(),
  });
