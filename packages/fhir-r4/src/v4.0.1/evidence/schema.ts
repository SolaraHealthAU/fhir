...
export function createEvidenceSchema() {
  const baseSchema: z.ZodType<types.Evidence> = z.object({
    ...
    relatedArtifact: z
      ...
      .optional(),
    exposureBackground: z.lazy(() => createReferenceSchema()),
    exposureVariant: z.array(z.lazy(() => createReferenceSchema())).optional(),
    outcome: z.array(z.lazy(() => createReferenceSchema())).optional(),
  });
