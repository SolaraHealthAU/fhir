...
export function createResearchDefinitionSchema() {
  const baseSchema: z.ZodType<types.ResearchDefinition> = z.object({
    ...
    comment: z.array(primitives.createStringSchema()).optional(),
    _comment: z.array(z.lazy(() => createElementSchema())).optional(),
    ...
    exposureAlternative: z.lazy(() => createReferenceSchema()).optional(),
    outcome: z.lazy(() => createReferenceSchema()).optional(),
  });
