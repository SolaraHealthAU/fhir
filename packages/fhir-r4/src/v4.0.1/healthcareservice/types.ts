...
import type { HealthcareServiceAvailableTime } from "../healthcareserviceavailabletime/types";
import type { HealthcareServiceNotAvailable } from "../healthcareservicenotavailable/types";
