import type { HealthcareService } from "../../src/v4.0.1/healthcareservice/types";

export const HealthcareserviceExample: HealthcareService = {
  ...
  extraDetails:
    "Several assessments are required for these specialist services, and the waiting times can be greater than 3 months at times. Existing patients are prioritized when requesting appointments on the schedule.",
  telecom: [
    {
      system: "phone",
      value: "(555) silent",
