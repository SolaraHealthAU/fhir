import type { ImmunizationEvaluation } from "../../src/v4.0.1/immunizationevaluation/types";

export const ImmunizationevaluationExampleNotvalid: ImmunizationEvaluation = {
...
export const ImmunizationevaluationExample: ImmunizationEvaluation = {
  resourceType: "ImmunizationEvaluation",
  id: "example",
  text: {
    status: "generated",
