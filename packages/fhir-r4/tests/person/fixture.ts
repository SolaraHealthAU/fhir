import type { Person } from "../../src/v4.0.1/person/types";

export const PersonExampleF002Ariadne: Person = {
  resourceType: "Person",
  id: "f002",
  text: {
    status: "generated",
...
export const PersonExample: Person = {
  resourceType: "Person",
  id: "example",
  text: {
    status: "generated",
...
export const PersonGrahame: Person = {
  resourceType: "Person",
  id: "grahame",
  text: {
    status: "generated",
...
export const PersonPatientPortal: Person = {
  resourceType: "Person",
  id: "pp",
  text: {
    status: "generated",
...
export const PersonProviderDirectory: Person = {
  resourceType: "Person",
  id: "pd",
  text: {
    status: "generated",
